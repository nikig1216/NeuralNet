...
void startTest() {
    ...
    /// Ask for input file, test set, and output file
    cout<<"Please enter the input file's name containing the specified initial neural network: ";
    cin >> inFile;
    cin.clear();
    cin.ignore(10000, '\n');

    cout<<"Please enter the test set file's name: ";
    cin >> testFile;
    cin.clear();
    cin.ignore(10000, '\n');

    cout<<"Please enter the desired output file's name to store the test results: ";
    cin >> outFile;
    cin.clear();
    cin.ignore(10000, '\n');
...
//        cout << "numIn: " << numI << " | numHidden: " << numH << " | numOut: " << numO << endl;
    ...
    testFileStream.open(testFile.c_str());
    ...
    if(testFileStream.is_open()) {
        ...
        Network.test(testFileStream,saveFileStream);

        testFileStream.close();
        saveFileStream.close();
    }
    else {
        cerr << "ERROR: Cannot open the testing data file. Program terminating." <<endl;
        return;
    }
